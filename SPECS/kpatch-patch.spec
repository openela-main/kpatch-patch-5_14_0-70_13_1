...
%define kernel_ver	5.14.0-70.13.1.el9_0
...
#
# https://bugzilla.redhat.com/2087138
Source100: CVE-2022-27666.patch
#
# https://bugzilla.redhat.com/2093170
Source101: CVE-2022-1966.patch
#
# https://bugzilla.redhat.com/2087132
Source102: CVE-2022-1012.patch
#
# https://bugzilla.redhat.com/2106306
Source103: CVE-2022-34918.patch
#
# https://bugzilla.redhat.com/2118959
Source104: CVE-2022-2585.patch
...
%changelog
* Mon Oct 17 2022 Yannick Cote <ycote@redhat.com> [1-4.el9_0]
- kernel: posix cpu timer use-after-free may lead to local privilege escalation [2118959] {CVE-2022-2585}

* Wed Sep 07 2022 Yannick Cote <ycote@redhat.com> [1-2.el9_0]
...
- kernel: Small table perturb size in the TCP source port generation algorithm can lead to information leak [2087132] {CVE-2022-1012}
